...
type Medium struct {
	ID             uint       `gorm:"primaryKey" json:"id"`
	MediaID        string     `gorm:"column:media_id;size:100;default:''" json:"mediaId"`
	LastUploadTime uint       `gorm:"column:last_upload_time;default:0" json:"lastUploadTime"`
	Type           int        `gorm:"default:0" json:"type"`
	IsSync         int        `gorm:"column:is_sync;default:0" json:"isSync"`
...
type Greeting struct {
	...
	Words     string     `gorm:"size:500;default:''" json:"words"`
	MediumID  uint       `gorm:"column:medium_id;default:0" json:"mediumId"`
	RangeType int        `gorm:"column:range_type;default:0" json:"rangeType"`
