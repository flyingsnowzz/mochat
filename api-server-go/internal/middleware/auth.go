...
func DashboardAuthMiddleware(cfg config.JWTConfig, whiteRoutes []string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if mochatRedis.RDB != nil {
			cacheKey := fmt.Sprintf("mc:user.%d", claims.UserID)
