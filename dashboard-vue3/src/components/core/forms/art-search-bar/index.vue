...
<template>
  <section class="art-search-bar" :class="{ 'is-expanded': isExpanded, 'art-card-xs': !noBorder }" :style="noBorder ? 'padding: 0; margin-bottom: 0; box-shadow: none;' : ''">
    <ElForm
      ref="formRef"
      :model="modelValue"
