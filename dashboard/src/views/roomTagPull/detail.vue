...
/**
 * 群邀请任务详情页面
 * 功能说明：查看群邀请任务的详细信息和数据统计
 * 主要功能：
 * 1. 查看任务基本信息：入群条件、已有多少人入群
 * 2. 查看群聊列表及每个群的入群情况
 * 3. 客户统计：已入群/未入群、已邀请/未邀请、发送完成/未完成
 * 4. 客户详情表格：客户名称、所属成员、送达状态、邀请群聊、是否入群
 * 5. 成员详情表格：成员、客户数、已邀请数、发送状态
 * 6. 筛选功能：按客户名称、成员、发送状态筛选
 *
 * 业务场景：
 * - 查看群邀请任务的执行效果
 * - 追踪客户的入群情况
 ...
 *
 * 技术实现：
 * - 使用 a-card 展示任务信息和统计数据
 * - 使用 a-table 展示客户和成员详情
 * - 使用 a-form-model 进行筛选
 * - 调用 labelShow、labelContactShow API
 */
