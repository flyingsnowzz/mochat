  ...
  <div class="wrapper">
    <div class="left">
      <a-card>
          ...
          <div class="data">
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template slot="title"> 企业客户总数 </template>
                    <span>总微信客户数</span>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template slot="title"> 企业群聊总数 </template>
                    <span>总微信群数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt="" />
                  </a-tooltip>
                </div>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template slot="title"> 企业群聊内客户总数 </template>
                    <span>总群成员数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt="" />
                  </a-tooltip>
                </div>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template slot="title"> 企业员工总数 </template>
                    <span>总企业成员数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt="" />
                  </a-tooltip>
                </div>
        ...
        <div class="chart-box">
          <p>
            实时概况<span>更新时间：{{ updateTime }}</span>
          </p>
            ...
            <div class="card-one card-all">
              <div class="card-left">
                <span
                  class="card-title"
                >本月新增好友数<img
                  :src="require('@/assets/systemHomePage/searchTwo-icon.png')"
                  alt=""
                /></span>
    ...
    .chart-box {
      ...
      .chart-data {
        ...
        div {
          ...
          flex-direction: column;
          border-radius: 5px;
          box-shadow: 0px 4px 10px 2px rgba(153, 153, 153, 0.2);
          .title {
            font-size: 10px;
            color: #999999;
          }
