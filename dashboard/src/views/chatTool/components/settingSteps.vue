...
/**
 * 聊天侧边栏配置步骤组件
 * 功能说明：展示配置企业微信聊天侧边栏的步骤指南
 * 主要功能：
 * 1. 说明聊天侧边栏的功能（内容引擎、客户CRM/群CRM）
 * 2. 展示第一步：设置企业微信侧边栏应用（显示应用图标和名称）
 * 3. 展示第二步：设置聊天侧边栏应用页面（提供页面URL和配置说明）
 * 4. 展示第三步：设置应用可信域名
 * 5. 提供前往企业微信后台的快捷链接
 *
 * 技术实现：
 * - 纯展示组件，通过 props 接收配置数据
 * - chatTools: 侧边栏工具列表（包含页面名称和URL）
 * - agents: 企业微信应用列表（包含应用图标和名称）
 * - whiteDomains: 可信域名列表
 */
export default {
  props: {
